...
sources=(
  "$fw/src/main.c" "$fw/src/protocol.c" "$fw"/src/protocol_*.c "$fw/src/worker.c" "$fw/src/event_ring.c" "$fw/src/sock_recv_commit.c" "$fw/src/transport_spi.c" "$fw/src/transport_sdio.c" "$fw/src/wifi_retry.c"
